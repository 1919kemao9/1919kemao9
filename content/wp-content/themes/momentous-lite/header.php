...
<link rel="icon" href="/images/favicon/32_icon.ico" type="image/x-icon" />
	...
	<div id="header-wrap">
		...
		<header id="header" class="container clearfix" role="banner">
			...
			<div id="logo">
				...
				<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
					<img src="http://1919kemao9-dev.uh-oh.jp/wordpress/wp-content/uploads/2014/12/logo_w.png">
				</a><br>
				
			<?php // Display Tagline on header if activated
			if ( isset($theme_options['header_tagline']) and $theme_options['header_tagline'] == true ) : ?>			
				<font class="site-description"><?php echo bloginfo('description'); ?></font>
			<?php endif; ?>
		...
		<div id="navigation-wrap">
			...
			<div id="navigation" class="container clearfix">
				...
				<p id="mainnav-icon-tablet" class="mainnav-icon"></p><p id="mainnav-icon-phone" class="mainnav-icon"></p>
